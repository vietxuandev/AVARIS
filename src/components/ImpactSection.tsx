    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-400/20 to-cyan-300/15 rounded-full blur-[140px]"
        />
      </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="glass-card rounded-[2rem] p-8 relative overflow-hidden h-full">
                ...
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto shadow-xl relative overflow-hidden">
