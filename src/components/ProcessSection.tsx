  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-blue-950/70 via-cyan-950/80 to-blue-900/70" />
      </motion.div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-500/15 to-cyan-400/10 rounded-full blur-[140px]"
        />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden opacity-15">
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-px h-full bg-gradient-to-b from-transparent via-cyan-300/40 to-transparent"
            style={{
              left: `${15 + i * 14}%`,
            }}
            animate={{
