...
import heroBg from "figma:asset/961eed0d9dde71a310d821a353928bda3b7828d3.png";
...
export function HeroSection() {
  ...
  const bottleY = useTransform(scrollY, [0, 1000], [0, -150]); // Bottle moves up faster
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <svg className="absolute w-0 h-0">
        <defs>
          ...
          <filter id="caustics" x="-50%" y="-50%" width="200%" height="200%">
            ...
            <feGaussianBlur in="causticColor" stdDeviation="2" result="causticBlur" />
          </filter>
        </defs>
      </svg>
      ...
      <motion.div 
        ...
        style={{ y: bgY }}
      >
        <div className="absolute inset-0" style={{ filter: "url(#waterFilter)" }}>
          <img 
            src={heroBg} 
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-900/30 via-blue-900/20 to-blue-900/40" />
        </div>
        
        {/* Animated Caustics Overlay */}
        <div className="absolute inset-0 opacity-40 mix-blend-screen" style={{ filter: "url(#caustics)" }}>
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-300/30 via-blue-400/20 to-transparent" />
        </div>
        ...
        >
          {[...Array(5)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1 h-full bg-gradient-to-b from-transparent via-cyan-200/20 to-transparent"
              style={{
                left: `${15 + i * 20}%`,
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-20 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-[100px]"
        />
        <motion.div
          animate={{ 
            x: [0, -120, 0],
          ...
          className="absolute bottom-0 left-1/4 w-[700px] h-[700px] bg-gradient-to-br from-blue-500/20 to-purple-500/15 rounded-full blur-[120px]"
        />
        <motion.div
          animate={{ 
            x: [0, 80, 0],
          ...
          className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-gradient-to-br from-cyan-300/15 to-sky-400/15 rounded-full blur-[100px]"
        />
        <motion.div
          animate={{ 
            x: [0, -60, 0],
          ...
          className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-gradient-to-br from-blue-400/15 to-cyan-500/15 rounded-full blur-[80px]"
        />
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center">
            ...
            >
              ...
              >
                Chai thủy tinh cao cấp, tái sử dụng - Kết hợp hoàn hảo giữa đẳng cấp và trách nhiệm với môi trường
              </motion.p>
              ...
              >
                <Button
                  ...
                  className="glass-button text-white px-12 py-8 text-lg rounded-[2rem] hover:bg-white/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl"
                >
