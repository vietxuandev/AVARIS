    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-1/4 w-[700px] h-[700px] bg-gradient-to-br from-blue-500/20 to-cyan-400/15 rounded-full blur-[150px]"
        />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20">
        {[...Array(5)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-full h-1 bg-gradient-to-r from-transparent via-cyan-300/40 to-transparent"
            style={{
              top: `${20 + i * 15}%`,
            }}
            animate={{
